...
public class PeripheralRoleActivity extends BluetoothActivity implements View.OnClickListener {
    ...
    private TextView tvMsgByte;
    private TextView tvMsgNoMSg;
    private TextView tvMsgConverted;
    private TextView tvMsgRcvd;
    private int noTimesMsgRcvd = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvmsg = findViewById(R.id.msgRcv);
        tvMsgByte = findViewById(R.id.msgByte);
        tvMsgConverted = findViewById(R.id.msgConverted);
        tvMsgNoMSg = findViewById(R.id.noTimeDataRcv);
        tvMsgRcvd = findViewById(R.id.msgRcvd);
    ...
    private void setBluetoothService() {
       ...
       //mSampleCharacteristic.setWriteType(BluetoothGattCharacteristic.WRITE_TYPE_NO_RESPONSE);
    ...
    private final BluetoothGattServerCallback mGattServerCallback = new BluetoothGattServerCallback() {
        ...
        public void onNotificationSent(BluetoothDevice device, int status) {
            ...
            showMsgText("on Notification sent");
        }
        ...
        public void onCharacteristicWriteRequest(BluetoothDevice device, int requestId, BluetoothGattCharacteristic characteristic, boolean preparedWrite, boolean responseNeeded, int offset, byte[] value) {
            ...
            showMsgText("on write request");
           // Log.v(MainActivity.TAG, "Characteristic Write request: " + Arrays.toString(value));

           // mSampleCharacteristic.setValue(value);
            noTimesMsgRcvd ++;
            tvMsgNoMSg.setText("No. of time data rcvd" + noTimesMsgRcvd);
            tvMsgByte.setText("" + Arrays.toString(value));

            tvMsgRcvd.setText("some msg is rcvd");
            String str =null;
            String msg = "";
            ...
            try {
                ...
                tvMsgConverted.setText("msg is converted at 1");
                noTimesMsgRcvd = 0;
            }
            catch (Exception x){
                tvMsgConverted.setText("msg is converted at 2");
           ...
           /* if (responseNeeded){
                tvResponse.setText("true");
            }
            else {
                tvResponse.setText("false");
            }
           */// showmsg(value);
        ...
        public void onDescriptorWriteRequest(BluetoothDevice device, int requestId,
            ...
            showMsgText("on descriptor request");
...
//            }
    ...
    // TODO : recieve etho message as object
    private void showmsg(byte[] value){
        Toast.makeText(this, "some message is received", Toast.LENGTH_SHORT).show();
        tvMsgRcvd.setText("some msg is rcvd");
        String str =null;
        String msg = "";
        ...
        try {
          /*  final BtMessageProtos.BtMessage.Builder btMessage = BtMessageProtos
                    .BtMessage.newBuilder();

            btMessage.setNameBytes(ByteString.copyFrom(value));*/
           /* final EthoMessageProtos.EthoMessage message = EthoMessageProtos
                    .EthoMessage.parseFrom(value);


            final EthoNavigationStepMessageProtos.EthoNavigationStepMessage bb = message.getEthoNavigationStepMessage();
*/
            final String finalMsg = msg;
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    tvmsg.setText("" + finalMsg);
